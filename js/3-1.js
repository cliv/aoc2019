...
var distances = intersections.map(intersection => { return intersection.split(",").reduce((a, b) => Math.abs(parseInt(a)) + Math.abs(parseInt(b)), 0) });
console.log(intersections, distances, Math.min.apply(null, distances));