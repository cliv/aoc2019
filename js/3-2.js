        ...
        for (i = 0; i < distance; i++) {
            switch (direction) {
                ...
                case 'D':
                    ...
                    break;
                default:
                    throw Error("HOW DID I GET HERE", instruction, direction, distance);
            }
...
console.log("paths");
fooPath = generatePath(foo);
barPath = generatePath(bar);
console.log("intersections");
var intersections = fooPath.filter(node => { return barPath.includes(node); })
console.log("distances");
var distances = intersections.map(intersection => { return [fooPath.findIndex((item) => item == intersection), barPath.findIndex((item) => item == intersection)]})
console.log("result", distances, intersections, distances[0][0] + distances[0][1]);